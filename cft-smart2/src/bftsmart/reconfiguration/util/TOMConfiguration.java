...
public class TOMConfiguration extends Configuration {
    ...
    protected void init() {
        ...
        try {
            ...
            //System.out.println(" ESTOU NA LINHA 86 da CLASSE TOMCONFIGURATION:     ACABEI DE LER SE É BFT OU NÃO e o valor é: "+s );
            ...
            rsaLoader = new RSAKeyLoader(this, TOMConfiguration.configHome, true);
