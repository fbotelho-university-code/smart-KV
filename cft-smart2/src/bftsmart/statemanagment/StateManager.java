...
public class StateManager {
    ...
    public boolean moreThan2F_Regencies(int regency) {
        ...
        //******* EDUARDO BEGIN **************//
        //return count > SVManager.getCertificateQuorum();
        return count > SVManager.getQuorumStrong();
        //******* EDUARDO END **************//
    }
    ...
    private ApplicationState getValidHash() {
        ...
        for (int i = 0; i < st.length; i++, count = 0) {
            ...
            for (int j = 0; j < st.length; j++) {
                ...
                //******* EDUARDO BEGIN **************//
                if (count > SVManager.getCurrentViewF()){
    ...
    public void analyzeState(int eid) {
            ...
            if (getWaiting() == -1) {
                ...
                if (tomLayer.execManager.isDecidable(eid)) {
                	//System.out.println("---DENTRO DO IS DECIDABLE!!!");
    ...
    private void requestState() {
    	//System.out.println("---ENTREI NO REQUEST STATE!!!");
        ...
        //System.out.println("---ENVIEI A MENSAGEM A PEDIR STATE!!!");
    ...
    public void SMRequestDeliver(SMMessage msg) {
    	//System.out.println("---RECEBI UMA MENSAGEM A PEDIR ESTADO!!!");
        ...
        //******* EDUARDO END **************//
        	//System.out.println("---ENTREI NO PRIMEIRO IF DO SMREQUESTDELIVER!!!");
            ...
            ApplicationState thisState = null;
            //TransferableState thisState = getLog().getTransferableState(msg.getEid(), sendState);
            if(SVManager.getStaticConf().isBFT()){
            	thisState = dt.getRecoverer().getState(msg.getEid(), sendState);
            }else{ 
            	if (sendState) {
            		//System.out.println("---ESTOU A DEFINIR O ESTADO DO SENDSTATE!!!");
            		thisState = dt.getRecoverer().getState(msg.getEid(), true);
            	}
            }
            ...
            //System.out.println("---ESTOU A ENVIAR O ESTADO!!!");
    ...
    public void SMReplyDeliver(SMMessage msg) {
        ...
        if (SVManager.getStaticConf().isStateTransferEnabled()) {
        	//System.out.println("---ENTREI NO PRIMEIRO IF DO SMREPLYDELIVER!!!");
        //******* EDUARDO END **************//
            ...
            if (getWaiting() != -1 && msg.getEid() == getWaiting()) {
            	//System.out.println("---ENTREI NO IF DO SMREPLYDELIVER!!!");
                ...
                if (moreThanF_Replies()) {
                	...
                	//System.out.println("---ENTREI NO TERCEIRO IF DO SMREPLYDELIVER!!!LINHA 506");                	 
                    ...
                    if(SVManager.getStaticConf().isBFT()){
	                    if (getReplicaState() != null) {
	                    	System.out.println("REPLICA STATE != NULL");
	                        byte[] hash = null;
	                        hash = tomLayer.computeHash(getReplicaState().getSerializedState());
	                        if (recvState != null) {
	                        	//System.out.println("RECEIVED STATE != NULL");
	                            if (Arrays.equals(hash, recvState.getStateHash())){
	                            	//System.out.println("Arrays.equals(hash, recvState.getStateHash()");
	                            	haveState = 1;
	                            	//System.out.println("haveState = 1;");
	                            }else 
	                            	if (getNumValidHashes() > SVManager.getCurrentViewF()){
	                            		//System.out.println("getNumValidHashes() > SVManager.getCurrentViewF()");
	                            		haveState = -1;
	                            	}else{
	                            		//System.out.println("ELSE------getNumValidHashes() > SVManager.getCurrentViewF()");
	                            	}
	
	                        }
	                    }
                    }else{
                    	//System.out.println("---ESTOU EM MODO CFT!!!LINHA 526");
                    	recvState = getReplicaState();
                    	haveState = 1;
                    }
                    ...
                    if (recvState != null && haveState == 1 && currentRegency > -1 &&
                    	...
                    	//System.out.println("---ESTOU A INSTALAR ESTADO!!!LINHA 533");
                    ...
                    //******* EDUARDO BEGIN **************//
                    	...
                    	if (recvState == null && (SVManager.getCurrentViewN() / 2) < getReplies()) {
                    //******* EDUARDO END **************//
