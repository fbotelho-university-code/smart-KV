    ...
    protected void processData(SystemMessage sm) {
        if (sm instanceof PaxosMessage) {
            ...
            if (paxosMsg.authenticated || paxosMsg.getSender() == myId){ 
            	...
            	//System.out.println("paxosMsg.authenticated || paxosMsg.getSender() == myId");
            }
            else if (paxosMsg.getPaxosType() == MessageFactory.STRONG && paxosMsg.getMACVector() != null) {
            	//System.out.println("paxosMsg.getPaxosType() == MessageFactory.STRONG && paxosMsg.getMACVector() != null");
                ...
                if (recvMAC != null && myMAC != null && Arrays.equals(recvMAC, myMAC)){
                	//System.out.println("recvMAC != null && myMAC != null && Arrays.equals(recvMAC, myMAC)");
                    acceptor.deliver(paxosMsg);
                }else {
        	...
        	//System.out.println("sm.authenticated");
            /*** This is Joao's code, related to leader change */
            if (sm instanceof LCMessage) {
            	//System.out.println("sm instanceof LCMessage");
            ...
            /** This is Joao's code, to handle state transfer */
                ...
                if (smsg.TRIGGER_SM_LOCALLY) {
                	//System.out.println("smsg.TRIGGER_SM_LOCALLY");
                    tomLayer.getStateManager().stateTimeout();
                }
                else if (smsg.getType() == TOMUtil.SM_REQUEST) {
                	//System.out.println("smsg.getType() == TOMUtil.SM_REQUEST");
                    tomLayer.getStateManager().SMRequestDeliver(smsg);
                } else {
                	//System.out.println("ELSE   smsg.getType() == TOMUtil.SM_REQUEST");
